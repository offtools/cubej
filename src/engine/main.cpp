...
VARF(grabinput, 0, 0, 1, { inputgrab(grabinput); conoutf("grabinput"); });
...
//__offtools__: prevent window from getting focus (change this later)
...
int main(int argc, char **argv)
{
    ...
    log("video: misc");
    SDL_WM_SetCaption("CubeJ Head", NULL); //__offtools__
    keyrepeat(false);
    SDL_ShowCursor(0);
    ...
    //__offtools__: use config on emptymap
    ...
    inputgrab(grabinput = true); //__offtools__: dont grab input
